      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start mb-8">
            <a
              href="#download"
              className="inline-flex items-center gap-2.5 bg-[#1d1d1f] text-white rounded-[980px] px-6 py-3 text-sm font-medium hover:bg-black transition-colors shadow-sm"
            >
          ...
          <div className="flex items-center gap-5 justify-center md:justify-start flex-wrap">
            <div className="flex items-center gap-1.5 text-sm text-[#6e6e73] font-body">
              <span className="text-yellow-400">★</span>
              <span className="font-medium text-[#1d1d1f]">4.8</span>
              <span>Rating</span>
            </div>
            <span className="text-[#d2d2d7]">·</span>
            <div className="flex items-center gap-1.5 text-sm text-[#6e6e73] font-body">
              <span className="font-medium text-[#1d1d1f]">10K+</span>
              <span>Students</span>
            </div>
            <span className="text-[#d2d2d7]">·</span>
            <div className="flex items-center gap-1.5 text-sm text-[#6e6e73] font-body">
              <span className="font-medium text-[#1d1d1f]">Free</span>
              <span>to Use</span>
            </div>
          </div>
        </div>
