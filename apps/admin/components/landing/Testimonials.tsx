    ...
    <section id="testimonials" className="bg-white py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center max-w-md mx-auto py-6">
          <span
            className="w-14 h-14 rounded-2xl bg-maroon/[0.08] flex items-center justify-center mb-5"
            aria-hidden="true"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 bg-maroon text-white rounded-xl px-5 py-2.5 text-sm font-medium hover:bg-maroon-light transition-colors"
          >
