  ...
  return (
    <div className="min-h-screen bg-surface-2">
      <main className="max-w-2xl mx-auto px-6 py-14">
        ...
        <h1 className="font-heading font-extrabold text-3xl text-ink tracking-tight mb-1">Contact</h1>
        ...
        <Section title="Beta Community">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-maroon text-white rounded-xl px-6 py-3 text-sm font-semibold hover:bg-[#9a0000] transition-colors shadow-sm"
          >
        ...
        <Section title="App Links">
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              ...
              <Link href="/#early-access" className="text-maroon underline">early-access form</Link>.
            </li>
          </ul>
        </Section>

        <div className="pt-6 border-t border-black/[0.08] text-sm text-ink-muted flex gap-4">
          <Link href="/privacy" className="text-maroon underline">Privacy Policy</Link>
